...
call s:hi("StatusLine2", "NONE", s:text, s:surface1, "NONE", "NONE")
call s:hi("GitDiffAdd", "NONE", s:green, "NONE", "NONE", "NONE")
call s:hi("GitDiffChange", "NONE", s:yellow, "NONE", "NONE", "NONE")
call s:hi("GitDiffRemove", "NONE", s:red, "NONE", "NONE", "NONE")
